...
- Finish with an overall summary of the findings in just 1 line. Please be precise in the statement, normal or abnormal. If it is normal then say "The ECG report shows normal findings". If it is abnormal then say "The ECG report shows abnormal findings". 
